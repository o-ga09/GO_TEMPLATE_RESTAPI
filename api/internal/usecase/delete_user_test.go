...
func TestDeleteUserUsecase_Run(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "正常系 - 管理者はユーザを削除できる", args: args{id: "000000000"}, mockValue: field{userRepoErr: nil, admin: admin_1, adminRepoErr: nil}, user_id: pkg.CtxInfo{RequestId: "9999999999"}, wantErr: false},
		{name: "正常系 - 一般ユーザは、自身の情報を削除できる", args: args{id: "000000000"}, mockValue: field{userRepoErr: nil, admin: admin_2, adminRepoErr: nil}, user_id: pkg.CtxInfo{RequestId: "0000000000"}, wantErr: false},
	}
